...
function getData(q1, q2, k, scroll = false) {
  $.ajax({
    ...
    url: "http://ds5500-backend-5.wd2ywwxp3m.us-east-1.elasticbeanstalk.com/getdata",
    traditional: "true",
...
function getPredictionFirstModel(q1, q2) {
  ...
  $.ajax({
    type: "POST",
    contentType: "application/json;charset=utf-8",
    url: "http://ds5500-backend-5.wd2ywwxp3m.us-east-1.elasticbeanstalk.com/predict-duplicate-with-first-model",
    traditional: "true",
...
function getPredictionSecondModel(q1, q2) {
  $.ajax({
    type: "POST",
    contentType: "application/json;charset=utf-8",
    url: "http://ds5500-backend-5.wd2ywwxp3m.us-east-1.elasticbeanstalk.com/predict-duplicate-with-second-model",
    traditional: "true",
    data: JSON.stringify({ q1: q1, q2: q2 }),
    dataType: "json",
    success: function (json_data) {
